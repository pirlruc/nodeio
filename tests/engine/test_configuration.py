...
from nodeio.engine.configuration import ListAction, DictAction, Graph, Node, InputStream
...
class TestListAction(unittest.TestCase):
    ...
    def test_json(self):
        action = ListAction(index=1)
        self.assertEqual(ListAction.model_validate_json(action.model_dump_json()),action)
...
class TestDictAction(unittest.TestCase):
    ...
    def test_json(self):
        action = DictAction(key="a")
        self.assertEqual(DictAction.model_validate_json(action.model_dump_json()),action)
...
class TestInputStream(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        stream_3 = InputStream(arg="c", stream="d", actions=[DictAction(key="e"),ListAction(index=1)])
        ...
        self.assertEqual(stream_3.actions,[DictAction(key="e"),ListAction(index=1)])

    def test_json(self):
        stream_1 = InputStream(arg="a", stream="b")
        stream_2 = InputStream(arg="c", stream="d", actions=[DictAction(key="e"),ListAction(index=1)])
        self.assertEqual(InputStream.model_validate_json(stream_1.model_dump_json()),stream_1)
        self.assertEqual(InputStream.model_validate_json(stream_2.model_dump_json()),stream_2)
...
class TestNode(unittest.TestCase):
    ...
    def test_invalid_data_type(self):
        with self.assertRaises(pydantic_core.ValidationError):
            ...
            Node(node="a",input_streams=[{"arg": "a", "stream": "b"}],output_stream=2)
            Node(node="a",input_streams=[{"arg": "a", "stream": "b"}],output_stream="a",options=123)
    ...
    def test_constructor(self):
        ...
        node_3 = Node(node="d", input_streams=[InputStream(arg="5",stream="6")], output_stream="2")
    ...
    def test_json(self):
        node_1_ori = Node(node="d", input_streams=[InputStream(arg="5",stream="6")], output_stream="2")
        node_2_ori = Node(node="e", input_streams=[InputStream(arg="1",stream="2")], output_stream="3", options={"4": "test"})
        print(node_1_ori)
        print(node_1_ori.model_dump_json())
        print(Node.model_validate_json(node_1_ori.model_dump_json()))
        self.assertEqual(Node.model_validate_json(node_1_ori.model_dump_json()),node_1_ori)
        self.assertEqual(Node.model_validate_json(node_2_ori.model_dump_json()),node_2_ori)
...
class TestGraph(unittest.TestCase):
    ...
    def test_invalid_key(self):
        with self.assertRaises(pydantic_core.ValidationError):
            Graph(nodes=[{"node": ""}],input_streams=["b"],output_streams=["c"])
            Graph(nodes=[{"node": "  "}],input_streams=["b"],output_streams=["c"])
            Graph(nodes=[{"node": "a"}],input_streams=[""],output_streams=["c"])
            Graph(nodes=[{"node": "a"}],input_streams=["  "],output_streams=["c"])
            Graph(nodes=[{"node": "a"}],input_streams=["b"],output_streams=[""])
            Graph(nodes=[{"node": "a"}],input_streams=["b"],output_streams=["  "])
    ...
    def test_at_least_one_ocurrence(self):
        ...
        with self.assertRaises(ValueError):
            Graph(nodes=[{"node": "a", "type": "node"}],input_streams=[],output_streams=["c"])
        with self.assertRaises(ValueError):
            Graph(nodes=[{"node": "a", "type": "node"}],input_streams=["b"],output_streams=[])

    def test_constructor(self):
        graph_1 = Graph(nodes=[{"node": "a", "type": "node", "output_stream": "1"}],input_streams=["b"],output_streams=["c"])
        graph_2 = Graph(nodes=[{"node": "a", "type": "node", "output_stream": "1"},Node(node="b", output_stream="2")],input_streams=["b","d"],output_streams=["c","e"])
    ...
    def test_json(self):
        graph_1_ori = Graph(nodes=[{"node": "a", "type": "node", "output_stream": "1"}],input_streams=["b"],output_streams=["c"])
        graph_2_ori = Graph(nodes=[{"node": "a", "type": "node", "output_stream": "1"},Node(node="b", output_stream="2")],input_streams=["b","d"],output_streams=["c","e"])
