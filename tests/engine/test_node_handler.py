...
from nodeio.engine.configuration import Node, InputStream
...
class TestNodeHandler(unittest.TestCase):
    def test_invalid_constructor(self):
        ...
        with self.assertRaises(pydantic_core.ValidationError):
            NodeHandler(id="",functor=create_complete_node)
        with self.assertRaises(pydantic_core.ValidationError):
            NodeHandler(id="  ",functor=create_complete_node)
        with self.assertRaises(pydantic_core.ValidationError):
            NodeHandler(id="  ",functor=create_complete_node)
        with self.assertRaises(pydantic_core.ValidationError):
            NodeHandler(id="a",functor=1)
    ...
    def test_invalid_functor(self):
        ...
        with self.assertRaises(TypeError):
            NodeHandler(id="a",functor=create_abstract_node)

    def test_constructor(self):
        def no_output(a: int):
            return a
        
        handler_1 = NodeHandler(id="a",functor=create_complete_node)
        handler_2 = NodeHandler(id="b",functor=create_complete_node_options)
        handler_3 = NodeHandler(id="c",functor=no_output)
        self.assertEqual(handler_1.id,"a")
        ...
        self.assertEqual(handler_2.id,"b")
        ...
        self.assertEqual(handler_3.id,"c")
    ...
    def test_invalid_identifier(self):
        ...
        handler = NodeHandler(id="a",functor=create_complete_node)
        with self.assertRaises(KeyError):
            handler.load(stream_handler=stream_handler, configuration=Node(node="b",output_stream="2"))
    ...
    def test_no_input_streams_with_mandatory_inputs(self):
        ...
        stream_handler = StreamHandler(graph=networkx.DiGraph())
        handler = NodeHandler(id="a",functor=mandatory_inputs)
        with self.assertRaises(ValueError):
            handler.load(stream_handler=stream_handler, configuration=Node(node="a",output_stream="2"))
    ...
    def test_no_input_arg(self):
        ...
        handler = NodeHandler(id="a",functor=mandatory_inputs)
        with self.assertRaises(KeyError):
            handler.load(stream_handler=stream_handler, configuration=Node(node="a",input_streams=[InputStream(arg="b",stream="1")],output_stream="2"))
    ...
    def test_no_output_stream(self):
        ...
        handler = NodeHandler(id="a",functor=mandatory_inputs)
        with self.assertRaises(KeyError):
            handler.load(stream_handler=stream_handler, configuration=Node(node="a",input_streams=[InputStream(arg="a",stream="1")],output_stream="2"))
    ...
    def test_load(self):
        ...
        handler_2 = NodeHandler(id="b",functor=create_complete_node_options)
        handler_1.load(stream_handler=stream_handler, configuration=Node(node="a",output_stream="1"))
        handler_2.load(stream_handler=stream_handler, configuration=Node(node="b",input_streams=[InputStream(arg="y",stream="3"),InputStream(arg="z",stream="4")],output_stream="2"))
        self.assertEqual(handler_1.id,"a")
        self.assertEqual(handler_1.functor,create_complete_node)
        self.assertEqual(handler_1.number_inputs,0)
        self.assertTrue(handler_1.has_output())
    ...
    def test_process_without_options(self):
        stream_handler = StreamHandler(graph=networkx.DiGraph())
        handler = NodeHandler(id="a",functor=CompleteNode().process)
        handler.load(stream_handler=stream_handler, configuration=Node(node="a",output_stream="1"))
    ...
    def test_process_with_options(self):
        ...
        handler = NodeHandler(id="b",functor=CompleteNodeOptions().load(y=2,z=3).process)
        handler.load(stream_handler=stream_handler, configuration=Node(node="b",input_streams=[InputStream(arg="x",stream="1")],output_stream="2"))
